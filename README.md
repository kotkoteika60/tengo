...
[![GoDoc](https://godoc.org/github.com/kotkoteika60/tengo?status.svg)](https://godoc.org/github.com/kotkoteika60/tengo)
...
```
go get github.com/kotkoteika60/tengo
```
...
Or, if you need to evaluate a simple expression, you can use [Eval](https://pkg.go.dev/github.com/kotkoteika60/tengo#Eval) function instead:
